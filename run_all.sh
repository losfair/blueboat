...
export RUST_LOG=rusty_workers=debug,rusty_workers_fetchd=debug,rusty_workers_runtime=info,rusty_workers_proxy=info
...
sfz -b 127.0.0.1 -p 3100 ./playground/webroot &
